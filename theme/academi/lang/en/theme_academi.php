...
$string['categoryimages'] = 'Front page category images';
$string['categoryimage'] = 'Image for category: {$a}';
$string['categoryimage_desc'] = 'Upload an image for the "{$a}" category (used on the front page tiles).';
$string['invalidimage'] = 'The uploaded file is not a valid image.';
$string['invalidimagesize'] = 'The image must be exactly {$a->width}x{$a->height} pixels.';
$string['headersliderheading'] = 'Header Slider';
$string['headersliderenabled'] = 'Enable Header Slider';
$string['headersliderenableddesc'] = 'Show or hide the header slider on the front page.';
$string['headerslidernum'] = 'Number of header slides';
$string['headerslidernumdesc'] = 'Number of slides to show under the main header.';
$string['headerslideheading'] = 'Header Slide {$a}';
$string['headerslideimage'] = 'Slide image';
$string['headerslidelink'] = 'Slide link';
$string['headerslidelinkdesc'] = 'Enter a link URL for this slide (optional).';
$string['slidelink'] = 'Slide {$a->slide} link';
$string['slidelink_desc'] = 'Enter the URL that this slide should link to.';
$string['mobileusos'] = 'USOS App';
$string['stats_title_main'] = 'Our';
