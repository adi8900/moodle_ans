...
// English logo file upload option - custom

$name = 'theme_academi/logo_en';
$title = get_string('logo_en','theme_academi');
$description = get_string('logodesc_en','theme_academi');
